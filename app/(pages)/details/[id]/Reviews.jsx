...
const Reviews = ({ id }) => {
    ...
    return (
        <>
            ...
            <div className="mt-8 flex flex-col md:flex-row items-center gap-4 md:gap-28 border rounded-lg py-4 px-6 w-full md:w-max">
                <input
                    className="outline-none flex-1 w-full md:w-auto"
                    type="text"
                ...
                <button
                    disabled={isPending}
                    onClick={mutate}
                    className="cursor-pointer rounded-lg py-2 px-6 text-xl text-white bg-blue-500 hover:bg-blue-400 transition-all w-full md:w-auto"
                >
                    Post
                </button>
            </div>
            <div className="mt-16 flex flex-col gap-6 md:gap-24 w-full md:w-1/3">
